...
public class Main {
    public static void main(String[] args) {
        ...
        mo1.add(m1);
        mo2.add(m4);
        User u1=new User("Sabina Gautam", "Kapan, Kathamandu","9808787944");
        User u2=new User("Riki Rai", "Bouddha, Kathmandu", "987969522");
        User u3=new User("Ganga Adhikari", "Sifal, Kathmandu", "9869856412");
        User u4=new User("Sam Oli", "Maitidevi, Kathmandu", "9845109412");
